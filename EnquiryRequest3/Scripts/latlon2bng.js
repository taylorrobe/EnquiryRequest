...
OsGridRef.parse = function(gridref) {
  ...
  // Luck change 5 to 0 so it round it to bottom left hand corner of the grid square
...
// ellipse parameters
var _e = { WGS84:    { a: 6378137,     b: 6356752.3142, f: 1/298.257223563 },
          Airy1830: { a: 6377563.396, b: 6356256.910,  f: 1/299.3249646   } };

// helmert transform parameters
var _h = { WGS84toOSGB36: { tx: -446.448,  ty:  125.157,   tz: -542.060,   // m
...
LatLon.prototype.convertOSGB36toWGS84 = function() {
  var p2 = convert(this, _e.Airy1830, _h.OSGB36toWGS84, _e.WGS84);
  return p2;
}


LatLon.prototype.convertWGS84toOSGB36 = function() {
  var p2 = convert(this, _e.WGS84, _h.WGS84toOSGB36, _e.Airy1830);
  return p2;
}
...
function convert(p, e1, t, e2) {
  ...
  return new LatLon(phi.toDeg(), lambda.toDeg());
}